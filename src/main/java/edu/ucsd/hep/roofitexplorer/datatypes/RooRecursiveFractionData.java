 ...
 * @author holzner
 */
public class RooRecursiveFractionData extends RooAbsRealData
{
  //----------------------------------------------------------------------

  public RooRecursiveFractionData(WorkspaceData workspace, String varName, String className, VerbosePrintOutput detailedData)
  {
