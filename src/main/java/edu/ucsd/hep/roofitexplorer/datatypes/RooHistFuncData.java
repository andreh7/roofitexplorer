 ...
 * @author holzner
 */
public class RooHistFuncData extends RooAbsRealData
{

  public RooHistFuncData(WorkspaceData workspace, String varName, String className, VerbosePrintOutput detailedData)
  {
